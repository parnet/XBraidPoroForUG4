...
public:
    ...
    void GetTILD(braid_Real *t_ptr,
                 braid_Int *iter_ptr,
                 braid_Int *level_ptr,
                 braid_Int *done_ptr) { braid_AccessStatusGetTILD(astatus, t_ptr, iter_ptr, level_ptr, done_ptr); }
...
public:
    ...
    void SetNRelax(braid_Int level, braid_Int nrelax) { braid_SetNRelax(core, level, nrelax); }
    ...
    void SetCFactor(braid_Int level, braid_Int cfactor) { braid_SetCFactor(core, level, cfactor); }
...
public:
    ...
    void SplitCommworld(const MPI_Comm *comm_world,
                        braid_Int px,
                        MPI_Comm *comm_x,
                        MPI_Comm *comm_t) { braid_SplitCommworld(comm_world, px, comm_x, comm_t); }
    ...
    void GetSpatialAccuracy(braid_StepStatus sstatus,
                            ...
                            braid_Real *tol_ptr) { braid_GetSpatialAccuracy(sstatus, loose_tol, tight_tol, tol_ptr); }
